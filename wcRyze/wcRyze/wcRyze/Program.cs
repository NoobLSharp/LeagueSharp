...
namespace wcRyze
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Game.PrintChat("<font color=\"#00FF80\">wcRyze -</font> <font color=\"#FFFFFF\">Loaded</font>");
            Game.PrintChat("Produzido por Noob");
        }
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            var dmgAfterComboItem = new MenuItem("DamageAfterCombo", "Dano apos o combo").SetValue(true);
            ...
            Config.SubMenu("Drawings")
                .AddItem(new MenuItem("QRange", "Q Alcance").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("WRange", "W Alcance").SetValue(new Circle(false, Color.FromArgb(255, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("ERange", "E Alcance").SetValue(new Circle(false, Color.FromArgb(255, 255, 255, 255))));
